...
const CallForSpeakers = () => (
  <MainLayout>
    <div className={styles.simpleText}>
      ...
      <p>
        This Call for Speakers closes on <strong>February 28th, 2019</strong>!
      </p>
      ...
      <ul>
        <li>Cutting-edge technological advances in the world of JavaScript or computer science in general, 
          if somehow applicable to JavaScript.</li>
        ...
        <li>And finally: Anything you want, that you feel passionate 
          about and relates to the Web or JavaScript</li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Your travel to Budapest covered.</strong><br /><br />
          We literally buy your plane or train ticket, plus your airport transfer, and travel around the city. 
          If you wish, you can arrange your travels, and invoice us later - we are happy to assist with booking 
          your itinerary, but if you wish to book yourself then invoice us later, that's also possible within 
          reasonable price ranges.
        </li>
        <li>
          <strong>Your stay in Budapest covered + and extra weekend to explore our city</strong><br /><br />
          In a great hotel near the venue (including free WiFi) for the days of the conference, 
          a day before, and the weekend after (i.e. Sept 28th-29th). If you want to stay longer, 
          we can arrange things, just let us know, but you may have to cover extra nights, though.

        </li>
        <li>
          <strong>Entrance to the conference + CSSConf Budapest.</strong><br /><br />
          We probably won’t be done with the speaker selections by the end of the ticket sales, 
          so if you want to make sure you can attend, just drop a mail to us and we will reserve 
          a ticket for you (just don't mention anything related your talk in that mail please). 
          If you get selected to speak and if you need to, we can refund your ticket, or you can 
          transfer it to anyone you like.
        </li>
        <li>
          <strong>You can bring your family</strong><br /><br />
          You can bring your significant other, bring your kid(s), they'll stay with you at the hotel.
          If you need child-care to be sorted out for the time of the conference, please also get in touch. 
          We are here to make this as easy for you as possible!
        </li>
      </ul>

      <p>
        If your employer can cover your travel and hotel, we are happy to list them as an awesome 
        company sponsor. The money we save will be used to make the conference more fabulous.
      </p>
      
      <p>
        If you have any special requirements, non-return trips, just let us know, we can usually 
        work these things out.
      </p>
      
      <h3>Guidelines</h3>
      <p>
        Submit your proposal by <strong>February 28th 2019, 23:59:59 CEST</strong>.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>Then we de-anonymize the top so we can bias against speaker details (eg. based on our budget, we might opt for a local or at least closer-by speaker).</li>
      </ul>

      <p>
        We follow the selection process laid out by our mentors at JSConnf & CSSconf EU: https://blog.cssconf.eu/2015/08/15/a-talk-selection-process-explained/ and value:
      </p>
      ...
      <p>
        Get in touch: <strong>team@jsconfbp.com</strong> (just please don’t use this address to submit a proposal).
      </p>  
