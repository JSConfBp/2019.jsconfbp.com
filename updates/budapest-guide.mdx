---
path: "/updates/budapest-guide"
date: "2019-08-23"
title: "Budapest Guide"
lead: "Take some quick trips around Budapest downtown, information about airport transfer, mobile data plans and transportation around the city"
socialCard: "social_card_budapest.jpg"
---
...
<PostImage image="richard-bohus-yZDATZKDoOo-unsplash" style={{transform: 'translateY(-13%)'}}  alt="Photo by Richard Bohus on Unsplash" />
...
<PostImage image="adam-sun-uxai8LrlJhw-unsplash" style={{transform: 'translateY(-23%)'}}  alt="Photo by Adam Sun on Unsplash" />
...
<PostImage image="yanny-mishchuk-fU9pbgetP1c-unsplash" style={{transform: 'translateY(-8%)'}}  alt="Photo by Yanny Mishchuk on Unsplash" />
...
<PostImage image="nina-tabatadze-OG5cZHYMa-Y-unsplash" style={{transform: 'translateY(-16%)'}}  alt="Photo by Nina Tabatadze on Unsplash" />
...
<PostImage image="krisztian-tabori-hmPOH_41WEU-unsplash" style={{transform: 'translateY(-26%)'}}  alt="Photo by Krisztian Tabori on Unsplash" />

_We thank Medea Baccifava for these trip guides_
...
<PostImage image="arvydas-venckus-eYqmWlHsDQo-unsplash" style={{transform: 'translateY(-29%)'}}  alt="Photo by Arvydas Venckus on Unsplash" />
...
Unfortunately Uber was banned from the city, there are alternatives by taxi companies, like FoTaxi and Taxify.

<PostImage image="breakslow-iGEivm-lkdQ-unsplash" style={{transform: 'translateY(-42%)'}}  alt="Photo by Breakslow on Unsplash" />
